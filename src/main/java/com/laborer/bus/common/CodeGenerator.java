package com.laborer.bus.common;
...
public class CodeGenerator {
    ...
    private static String packageName = "com.laborer.bus"; // 生成的包名
    ...
    private static String author = "xiaoqiang";    // 作者
...
//                .setTablePrefix(tablePrefix)
                ...
                .setSuperEntityClass("com.laborer.bus.common.entity.BaseEntity")
                .setSuperControllerClass("com.laborer.bus.common.controller.BaseController");
