package com.laborer.bus.common.aspect;
...
import com.laborer.bus.common.annotation.Log;
...
public class ActionAspect {
	...
	@Pointcut("@annotation(com.laborer.bus.common.annotation.Log)")
	...
	private void saveActionLog(JoinPoint joinPoint, long time, boolean isAround) {
		...
		com.laborer.bus.modules.sys.entity.Log actionLog = new com.laborer.bus.modules.sys.entity.Log();
